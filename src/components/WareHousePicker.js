...
export default class WareHousePicker extends Component {
  constructor(props) {
    super(props);
  ...
  getPickerTitle(){
    ...
    if(!value){
      ...
      var options=null;
      var strtitle='';
      if (this.props.optionWhKey) {
        if (vouch && vouch.options && vouch.options[this.props.optionWhKey]) {
          options = vouch.options[this.props.optionWhKey];
        }
      } else {
        if (vouch && vouch.options && vouch.options['Vouch.ToWhId']) {
          options = vouch.options['Vouch.ToWhId'];
        }
      }
      if(options){
            ...
            <View style={styles.modalview}>
              <View style={styles.navbar}>
                ...
                <View style={styles.navtitle}>
                  <Text style={styles.navtitletext}allowFontScaling={false}>仓库</Text>
                </View>
              </View>
